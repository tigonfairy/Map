...
class MapController extends AdminController
{
    ...
    public function listMapUserData(Request $request)
    {
        ...
        return Datatables::eloquent($areas)
            ...
            ->addColumn('background', function ($area) {
                return $area->background_color . ' ' . '<span style="display:inline-block;width: 20px;height:20px;background:' . $area->background_color . '"></span>';
            })
