...
<div class="row">
    <table border="1">
                    ...
                    @if($products->count())
                        ...
                        @foreach($products as $product)
                            ...
                            @php
                                ...
                                $group_name_cbd .= '<td >'.number_format($cbd).'</td>';
                                $group_name_maxgreen .= '<td >'.number_format($maxgreen).'</td>';
                                $group_name_maxgro .= '<td >'.number_format($maxgro).'</td>';



                                $total_product = $cbd+$maxgreen+$maxgro;
                                $total_group .= '<td class="total_group">'.number_format($total_product).'</td>';
                        ...
                        @php
                            ...
                            $total_product_group = $group_cbd + $group_maxgreen + $group_maxgro;
                             $total_view .= '<td class="name_product">'.number_format($total_product_group).'</td>'.$total_group;
        ...
        <tr>
            ...
            <td class="total">{{number_format($total_cbd + $total_maxgreen + $total_maxgro)}}</td>
            {!! $total_view  !!}
        </tr>
        ...
        <tr>
            ...
            <td class="total">{{number_format($total_cbd)}}</td>
            {!! $value_cbd !!}
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td class="total">{{ number_format($total_maxgreen) }}</td>
            {!! $value_maxgreen !!}
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td class="total">{{ number_format($total_maxgro) }}</td>
            {!! $value_maxgro !!}
        </tr>
